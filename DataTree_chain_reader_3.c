...
/////////////////Average q vector for further recentering
	...
	for(Int_t entry = 0; entry <= data_chain->GetEntries(); entry++)
	{
		...
		if(_cuts.IsGoodEvent(*event))
		{
			...
			Temp_Av_Q1x_PSD += Av_Q1x_PSD/Total_PSD_Energy ;
			Temp_Av_Q1y_PSD += Av_Q1y_PSD/Total_PSD_Energy ;


		}
	}

	Av_Q2x_TPC /= TPC_iter_counter ;
	Av_Q2y_TPC /= TPC_iter_counter ;
	
	Av_Q1x_PSD = Temp_Av_Q1x_PSD/PSD_iter_counter ;
	Av_Q1y_PSD = Temp_Av_Q1y_PSD/PSD_iter_counter ;
...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	for(Int_t entry = 0; entry <= data_chain->GetEntries(); entry++)
	{
		...
		if(_cuts.IsGoodEvent(*event))
		{
			...
			Q2x_TPC/=TPC_iter_counter;
			Q2y_TPC/=TPC_iter_counter;
			...
			Q1x_PSD/=PSD_iter_counter;
			Q1y_PSD/=PSD_iter_counter;
